...
class WsSwooleClient
{
     ...
     * @param bool   $masked
     */
    public function send(string $data, $type = 'text', $masked = true)
    {
     ...
     * @return bool|string
     */
    private function hybi10Encode(string $payload, $type = 'text', $masked = true)
    {
        // var_dump($payload);
        $frameHead = array();
        $frame = '';
