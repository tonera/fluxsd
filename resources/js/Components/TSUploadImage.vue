...
const props = defineProps(['name','desc', 'def']);
...
<template>
    ...
    <div v-if="init_image != null" class="m-1 h-full w-full relative inline-flex items-center p-3 text-sm font-medium text-center text-white bg-gray-200 rounded-lg hover:bg-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700">
        <img :src="init_image" class="object-cover w-36 h-36">
    ...
    class="m-1 flex h-full w-full flex-col items-center justify-center border-2 border-gray-400 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-200">
        <div class="flex flex-col items-center justify-center p-4">
            ...
            <input id="dropzone-file" type="file" multiple accept="image/png, image/jpeg" class="hidden" @input="uploadMutiFile($event)"/>
