...
if(page.props.languages != null){
    if(page.props.locale!=null && page.props.languages[page.props.locale]!=null){
        ...
        // console.log("语言包存丰",currentLang.value);
    }
}
const showingNavigationDropdown = ref(false);

// console.log(page.props.oddStatus);
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('image.index')" :active="route().current('image.index')">
                                    {{trans('image')}}
                                </NavLink>
                                <NavLink :href="route('text.index')" :active="route().current('text.index')">
                                    {{trans('Text')}}
                                </NavLink>

                                <div class="hidden lg:flex items-center cursor-pointer z-10">
                                    <ul class="menu menu-horizontal">
                                    <li>
                                        <details>
                                        <summary>{{trans('Tool')}}</summary>
                                        <ul class=" w-48">
                                            <li><a :href="route('tools.cropper')">{{trans('Edit image')}}</a></li>
                                            <li><a :href="route('tools.upscale')">{{trans('HD image')}}</a></li>
                                            <li><a :href="route('tools.removebg')">{{trans('Remove BG')}}</a></li>
                                            <li><a :href="route('tools.faceswap')">{{trans('Face swap')}}</a></li>
                                        </ul>
                                        </details>
                                    </li>
                                    </ul>
                                ...
                                <NavLink :href="route('models')" :active="route().current('models')">
                                    {{trans('model')}}
                                </NavLink>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            ...
                            <div v-show="$page.props.tuseHasRegister" class="ms-3 relative">
                                <PartJob :label="trans('odd')" :def="$page.props.oddStatus"></PartJob>
                            </div>
                        </div>
